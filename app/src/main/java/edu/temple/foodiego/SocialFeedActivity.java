...
public class SocialFeedActivity extends AppCompatActivity implements FirebaseHelper.GetFriendsActivityResponse, FirebaseHelper.GetFriendsResponse {
    ...
    private ArrayList<FoodieActivityLog> activities;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(savedInstanceState != null){
            activities = (ArrayList<FoodieActivityLog>) savedInstanceState.getSerializable("feed");
        }
        if(activities != null){
    ...
    protected void onSaveInstanceState(@NonNull Bundle outState) {
        outState.putSerializable("feed", activities);
